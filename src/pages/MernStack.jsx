...
const MernStack = () => {
  ...
  return <div className="min-h-screen py-40 px-5 md:px-10 lg:px-16 xl:px-[20%] text-white grid gap-10 lg:gap-32 place-content-center w-screen overflow-hidden">
